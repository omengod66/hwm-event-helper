...
export default async function processBattlePage() {
    if (location.href.includes("war.php") &&
        ...
        if (["133", "135", "138", "139", "140", "142", "143", "144", "147", "148", "150"].includes(battleType)) {
            ...
            function main() {
                if (typeof finished !== "undefined" && finished || typeof battle_ended !== "undefined" && battle_ended) {
                    ...
                    } else if ((battleType === "142" || battleType === "143" || battleType === "150" || battleType === "138" || battleType === "148") && get("auto_send_ffa_event", true)) {
